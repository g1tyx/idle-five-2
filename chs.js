...
var cnItems = {
    ...
    'Hey boss, everyone in Los Santos is talking about': '',
    '': '',
    '': '',
    '': '',
    '': '',
...
var cnRegReplace = new Map([
    ...
    [/^Union Depository Robbing (.+)$/, '读书人的联邦储蓄银行 $1'],
    [/^Pickpocketing (.+)$/, '扒窃 $1'],
    [/^Meth Workshop (.+)$/, '冰糖车间 $1'],
    [/^Cocaine Workshop (.+)$/, '海牌烟草车间 $1'],
